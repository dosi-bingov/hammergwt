...
public class NativeHammerEvent extends JavaScriptObject {
	 ...
	 * It doesn't make any sense, only for the drag events, since most browsers support dragstart-drag-dragend.
	 * It is in Hammer, because document.createEvent adds these, and Hammer uses this for creating DOM events.
	 */
...
//
//                event.@org.hammergwt.client.event.HammerEvent::setScale(Ljava/lang/String;)(scale);
//
//                event.@org.hammergwt.client.event.HammerEvent::setEventValues(Lcom/google/gwt/core/client/JsArrayString;Lcom/google/gwt/core/client/JsArrayMixed;)(properties, values);
//
//                // handler.@org.hammergwt.client.handler.HammerPinchHandler::onPinch(Lorg/hammergwt/client/event/HammerEvent;)(event);
//            });
//
//        return hammertime;
